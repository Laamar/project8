...
public class Driver {
    ...
    public static void main(String[] args) {
      ...
      try {
            ...
            dataLocation = Paths.get(Driver.class.getResource("/" + fileName).toURI());
        ...
        try {
            ...
            Path folderLocation = Paths.get(Driver.class.getResource("/").toURI());
    ...
    public static String[][] readData(Scanner fileScan) {
        ...
        //while loop over the stack and count the number of times each word appears.
        ...
        while (!stackTemp.isEmpty()) {
            ...
            //TreeSet will automatically sort the words by count.
    ...
    public static void writeData(String[][] words, String location) throws URISyntaxException, IOException {
        ...
        // Get the path to the folder
        // This is a relative path, so it will work on any computer
        Path locationPath = Paths.get(Driver.class.getResource("/edu/guilford/").toURI());
